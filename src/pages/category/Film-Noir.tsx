...
export default function Home() {
    ...
    const [genre, setGenre] = useState("Film-Noir");
                            ...
                            <div className="flex justify-between w-full max-sm:flex-col items-center max-lg:flex-col">
                                ...
                                <div className="flex max-lg:flex-col">
                                    <input
                                        ...
                                        className="border-1 px-10 py-1 bg-gray-700 cursor-default text-white rounded-md text-xl border-1 p-5 rounded-md cursor-pointer bg-stone-600 relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden font-medium rounded-lg bg-red-800 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400">

                                    </input>
                                    <select
                                        className="border-1 px-10 py-1 bg-gray-700 text-white rounded-md text-xl border-1 p-5 rounded-md cursor-pointer bg-stone-600 relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden font-medium rounded-lg bg-red-800 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400"
                                        value={genre}
